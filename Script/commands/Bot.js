...
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Tanvir Hasan☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100000654976375\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:TANVIR ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস তানভীর  আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Tanvir ッ❤️ তাকে সবাই তানভীর নামে  চিনে🤙", threadID);
   };
...
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস তানভীর এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };
...
   };
  if ((event.body.toLowerCase() == "তৌসিফ ") || (event.body.toLowerCase() == "সেলিম")) {
     return api.sendMessage("🥰--🌺 আমার বস তানভীর এর বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
...
     return api.sendMessage("ভাই তুই এত হাসিস না হাসলে তোরে গুরুর মত লাগে..!🌚🤣", threadID);
   };
